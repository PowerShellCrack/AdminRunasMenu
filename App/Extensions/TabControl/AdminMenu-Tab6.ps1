...
function Call-btnTab6_01{
    Start-ButtonProcess -ProcessCall invoke -File "ClipboardHistoryViewer.ps1" -OutputTab tab1 -CreateNoWindow
}
...
function Call-btnTab6_17{
    Start-ButtonProcess -ProcessCall ps1 -File "LazyWinAdmin-v0.4.ps1" -WorkingScriptDirectory "LazyWinAdmin-v0.4" -OutputTab tab1 -CreateNoWindow
}
